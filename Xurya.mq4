...
input float    sl_pips = 50;
input int      trailing_pips=150;
...
void EntryAnalysis(){
   ...
   if(sig==OP_BUY){
      ticket=OrderSend(pair, OP_BUY, lot_size, Ask, 10*unit_pip, Ask-sl_pips*unit_pip, 0, "Generated by Xurya Bot!",MAGICMA,0,clrLightGreen);
   }else if(sig == OP_SELL){
      ticket=OrderSend(pair, OP_SELL, lot_size, Bid, 10*unit_pip, Bid+sl_pips*unit_pip, 0, "Generated by Xurya Bot!",MAGICMA,0,clrPurple);
   }
}
